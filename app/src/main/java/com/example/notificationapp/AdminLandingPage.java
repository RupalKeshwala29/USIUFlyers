...
public class AdminLandingPage extends AppCompatActivity {
    private Button AddUser,ModifyUser,ModifyEvent,SendNotification,EventAttendance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EventAttendance=(Button) findViewById(R.id.EventAttendance);
        ...
        EventAttendance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),EventAttendance.class);
                startActivity(intent);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            }
        });
